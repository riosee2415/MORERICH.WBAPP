...
import { MODIFY_PRODUCTTYPE_REQUEST } from "../../reducers/store";
...
const PTypeWorkInput = ({ compare, initValue = "", row, type = "text" }) => {
  ...
  const actionHandler = useCallback(() => {
    if (compare === "value") {
      dispatch({
        type: MODIFY_PRODUCTTYPE_REQUEST,
        data: {
          value: value,
          id: reRow.id,
        },
